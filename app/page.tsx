...
export default async function Home() {
  try {
    // Llama a la función getProjects para obtener los proyectos desde la API
    const projects = await getProjects();

    // Renderiza la página con los proyectos obtenidos
    return (
    ...
    // Renderiza un mensaje de error en caso de fallo en la solicitud
    return (
      <div className="container mx-auto max-w-5xl py-20">
        <h1>Error</h1>
